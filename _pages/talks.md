...
<div class="row justify-content-center">
    <div class="col-sm-5 mt-3 mt-md-0 text-center">
        {% include figure.liquid path="assets/img/encode-africa.jpeg" caption="Keynote speaker announcement, Encode Africa AI Safety Action Week" class="img-fluid rounded z-depth-1" style="max-height: 350px; width: auto;" %}
    </div>
    <div class="col-sm-5 mt-3 mt-md-0 text-center">
        {% include figure.liquid path="assets/img/encode-africa-bio.jpeg" caption="Speaker profile, Encode Africa AI Safety Action Week" class="img-fluid rounded z-depth-1" style="max-height: 350px; width: auto;" %}
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-sm-5 mt-3 mt-md-0 text-center">
        {% include figure.liquid path="assets/img/scholarship-clinic.jpeg" caption="Panelists, YSN Lagos Scholarship Clinic 3.0" class="img-fluid rounded z-depth-1" style="max-height: 350px; width: auto;" %}
    </div>
    <div class="col-sm-5 mt-3 mt-md-0 text-center">
        {% include figure.liquid path="assets/img/scholarship-clinic-bio.jpeg" caption="Speaker feature, YSN Lagos Scholarship Clinic 3.0" class="img-fluid rounded z-depth-1" style="max-height: 350px; width: auto;" %}
    </div>
</div>
